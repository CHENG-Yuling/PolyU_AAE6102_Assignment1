...
% based only. 
settings.skipNumberOfBytes     = 1000;%7000*26000*2;

%% Raw signal file name and other parameter ===============================
% This is a "default" name of the data file (signal record) to be used in
% the post-processing mode
settings.fileName           = 'D:\OneDrive-polyu-edu-hk\OneDrive - The Hong Kong Polytechnic University\AAE\FYP\Group 1 Spoofing\gps-sdr-sim-master\gpssim.bin';%'C:\Users\gnss\Desktop\Discussion\Amungo Navigation for NUT4NT+\dump_ch1.bin';  
...
settings.samplingFreq       = 10e6;%58e6;        % [Hz]
